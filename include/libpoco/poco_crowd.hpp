...
namespace Poco
{
    ...
    public:
        ...
        void inform_network_final_block(nlohmann::json final_block_j, std::string new_block_nr, nlohmann::json rocksdb_j);
    ...
    private:
        void inform_network_prel_block(std::string my_next_block, nlohmann::json block_j);
    private:
