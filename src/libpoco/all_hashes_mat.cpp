...
{
    std::pair<enet_uint32, std::string> myPair = std::make_pair(participant, hash_of_email);
...
std::vector<std::shared_ptr<std::pair<enet_uint32, std::string>>> IpHEmail::get_all_ip_hemail_vec()
{
...
void IpAllHashes::add_ip_hemail_to_ip_all_hashes_vec(std::shared_ptr<std::pair<enet_uint32, std::string>> ptr_ip_hemail)
{
...
std::vector<std::shared_ptr<std::pair<enet_uint32, std::string>>> IpHEmail::ip_hemail_vec_ = {};

std::vector<std::shared_ptr<std::pair<enet_uint32, std::string>>> IpAllHashes::ip_all_hashes_vec_ = {};
std::vector<std::vector<std::shared_ptr<std::pair<enet_uint32, std::string>>>> IpAllHashes::ip_all_hashes_2d_mat_ = {};
std::vector<std::vector<std::vector<std::shared_ptr<std::pair<enet_uint32, std::string>>>>> IpAllHashes::ip_all_hashes_3d_mat_ = {};