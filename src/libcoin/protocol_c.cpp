...
std::string ProtocolC::get_last_block_nr_c()
{
    ConfigDir cd;
...
nlohmann::json ProtocolC::get_blocks_from_c(std::string &latest_block_peer)
{
...
std::string ProtocolC::get_all_users_from_c(std::string &latest_block_peer)
{
